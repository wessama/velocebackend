...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-amenityAssets">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($assets as $key => $asset)
                        <tr data-entry-id="{{ $asset->id }}">
                            ...
                            <td>
                                @foreach($asset->amenities as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-amenityAssets:not(.ajaxTable)').DataTable({ buttons: dtButtons })
