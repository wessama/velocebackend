    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets-histories.update", [$assetsHistory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" type="number" name="mileage" id="mileage" value="{{ old('mileage', $assetsHistory->mileage) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_indicator') ? 'is-invalid' : '' }}" type="number" name="fuel_indicator" id="fuel_indicator" value="{{ old('fuel_indicator', $assetsHistory->fuel_indicator) }}" step="1" required>
